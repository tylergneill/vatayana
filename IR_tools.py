...
def format_docCompare_link(doc_id_1, doc_id_2, display_string="dcCp", title=""):
    ...
    return f"<a class='doc-compare-link' data-doc1='{doc_id_1}' data-doc2='{doc_id_2}' target='docCompare' title='{title}' rel='nofollow' style='cursor:pointer; text-decoration:underline;'>{display_string}</a>"
